const products = [
...

  {
    ...
    construction: [
      {
        component: "Conductor",
        material:
          "High Conductivity Annealed Copper (Class 1/2 )",
      ...
      {
        component: "Core Identification",
        material: "Multiple colors: Red, Yellow, Blue, Green, Black, Grey, White",
    ...
    performanceParameters: [
      ...
      { property: "Conductor Temperature", value: "70 °C (PVC), 85 °C (FRLS), 90 °C (ZHFR)" },
      { property: "Short Circuit Temp.", value: "Up to 160 °C (PVC), 250 °C (ZHFR)" },
      ...
      { property: "Service Life", value: "25+ Years (under standard conditions)" }
    ],
...

  {
    ...
    variants:[
      {
        ...
        "gauge": 109,
        "coresLength": [100, 500, 1000],
        "cableType": ["Tinned Copper", "Heat-Resistant PVC Insulation", "Nylon Sheath"],
        "color": ["black", "grey"],
        "colorCustomization": false,
        "weight": "10kg - 12kg",
        "dimension": "18mm - 19mm",
    ...
    construction: [
      ...
      },
      {
        component: "Insulation",
        material:
          "Heat-Resistant PVC Compound (Type C))",
      ...
      },
      {
        ...
        material:
          "Nylon Outer Sheath",
          Function: "Provides abrasion resistance, flame resistance, and chemical protection",
      },
      {
        component: "Category",
        material:
      ...
      },
      {
        ...
        material:
          "1.5 sq.mm to 120 sq.mm (15 AWG – 4/0 AWG)",
     ...
     { property: "Service Life", value: "20+ Years under standard use" },
      ...
      { description: "Power supply in compact or high-temperature environments." },
      ],
      ...
      manufacturing: [
         ...
         },
        {
          ...
          description: " A heat-resistant polyvinyl chloride insulation layer had been extruded over the conductor.",
        },
        {
          step: "Glass Fibre Braid Applied",
          description: " A woven glass fibre braid had been applied and had been impregnated to stabilise the layer.",
        },
        {
          step: "Nylon Braid or Jacket Applied",
          description: " A nylon braid or jacket had been applied to provide abrasion resistance.",
        },
        {
          step: "Varnish or Finish Cured",
          description: " Protective varnish coats had been applied and cured where specified.",
        ...
        },
        {
          ...
          description: " High-temperature ageing, dielectric strength, and flexibility at low temperature had been verified.",
        },
        {
...

  {
    ...
    [
      {
        ...
        "gauge": 0.5,
        "coresLength": [500,1000],
        "cableType": ["Copper Conductor", "PVC/XLPE Insulated", "Shielded/Unshielded"],
        "color": ["black" , "grey"],
        "colorCustomization": false,
        "weight": "120kg - 450kg",
        "dimension": "8mm - 35mm",
    ...
    performanceParameters: [
      ...
      { property: "Short Circuit Temp.", value: "Up to 160 °C (PVC), 250 °C (XLPE)" },
      { property: "Dielectric Strength", value: "3.5 kV for 5 minutes" },
      { property: "Insulation Resistance", value: "> 1 MΩ/km at 27 °C" },
      { property: "Crosstalk", value: "Minimized with twisted pairs/triads" },
      { property: "Shield Effectiveness", value: "> 90% coverage (foil/braid shield)" },
    ...
    applications: [
      {
        description: "Process control systems in power plants, oil & gas, and refineries.",
      },
      {
        description: "Instrumentation & signal transmission in chemical and pharmaceutical plants.",
      },
      {
  ...
  },
  {
    ...
    variants: [
      {
        ...
        "gauge": 0.5,
        "coresLength": [100],
        "cableType": ["Flexible Copper Conductor", "PVC Insulated", "PVC Sheathed"],
    ...
    construction: [
      ...
      },
      {
        component: "Temperature Rating",
        material:
          "70 °C (PVC), 90 °C (XLPE), up to 125 °C for special grades",
        Function: "Withstands high engine bay temperatures",
      },
      {
        component: "Category",
        material:
          "Single Core (standard) / Multi-core on request",
    ...
    performanceParameters: [
      { property: "Rated Voltage", value: "1100 V" },
      { property: "Conductor Temperature", value: "70 °C (PVC), 90 °C (XLPE), 125 °C (Special Grades" },
      { property: "Short Circuit Temp.", value: "160 °C (PVC), 250 °C (XLPE)" },
      { property: "Dielectric Strength", value: "3.5 kV for 5 minutes" },
      { property: "Insulation Resistance", value: "> 1 MΩ/km at 27 °C" },
      { property: "Oil & Fuel Resistance", value: "Excellent (suitable for engine bay)" },
      { property: "Flexibility", value: "High (Class 5 stranded conductor)" },
      { property: "Service Life", value: "15-20+ Years under standard operating conditions" },
    ],
    applications: [
      { description: "Wiring harnesses in automobiles (cars, buses, trucks, tractors)." },
    ...
    manufacturing: [
      {
        ...
        description: "High-flexibility conductors had been produced by drawing, annealing, and fine stranding.",
      },
      {
        step: "Conductor Tinned Where Required",
        description: "Tin coating had been applied to enhance corrosion resistance where specified.",
      },
      {
        step: "Thin-Wall Insulation Extruded",
        description: "Heat-resistant polyvinyl chloride or cross-linked polyethylene thin-wall insulation had been extruded with precise wall control.",
      },
      {
        step: "Colour Coding and Legend Applied",
        description: " Colour stripes and identification legends had been applied for harness assembly.",
      },
      {
        step: "Spooling and Length Control Performed",
        description: " Tight tolerance spooling had been completed for automated cutting.",
      },
      {
        step: "Routine Tests Conducted",
        description: "Spark, insulation thickness, hot-oil, hot-abrasion, tensile and elongation, and cold-bend tests had been completed.",
      },
      {
        step: "Harness Readiness Verified",
        description: " Dimensional and concentricity checks had been recorded to ensure connector compatibility.",
      },
    ],
...

  {
    ...
    variants: [
        ...
        construction: [
      {
        component: "Conductor",
        material:
          "High Conductivity Flexible Copper (Class 5, Annealed)",
    ...
    performanceParameters: [
      { property: "Rated Voltage", value: "1100 V" },
      { property: "Conductor Temperature", value: "70 °C (PVC), 90 °C (ZHFR/XLPE)" },
      { property: "Short Circuit Temp.", value: "160 °C (PVC), 250 °C (ZHFR/XLPE)" },
      { property: "Dielectric Strength", value: "3.5 kV for 5 minutes" },
      { property: "Insulation Resistance", value: "> 1 MΩ/km at 27 °C" },
      { property: "Flexibility", value: "Excellent (Class 5 conductor)" },
      { property: "Mechanical Strength", value: "High tensile & impact resistance" },
      { property: "Service Life", value: "20+ Years under normal operating conditions" },
    ],
    ...
    variants: [
      {
        ...
        "gauge": 1.5,
        "coresLength": [500, 1000],
        "cableType": ["Copper/Aluminium Conductor", "PVC/XLPE Insulated", "PVC/LSZH Sheathed"],
        "color": ["black"],
        "colorCustomization": false,
        "weight": "180kg - 280kg",
        "dimension": "12mm - 15mm",
